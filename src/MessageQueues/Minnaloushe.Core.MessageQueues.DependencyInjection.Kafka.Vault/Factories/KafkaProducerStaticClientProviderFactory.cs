...
internal class KafkaProducerStaticClientProviderFactory(IServiceProvider serviceProvider) : IKafkaProducerClientProviderFactory
{
    ...
    public IKafkaProducerClientProvider Create(string connectionName)
    {
        ...
        return ActivatorUtilities.CreateInstance<KafkaProducerStaticClientProvider>(
            serviceProvider,
            connectionName,
