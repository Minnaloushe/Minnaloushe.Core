...
internal class KafkaConsumerStaticClientProviderFactory(IServiceProvider serviceProvider) : IKafkaConsumerClientProviderFactory
{
    ...
    public IKafkaConsumerClientProvider Create(string connectionName)
    {
        ...
        return ActivatorUtilities.CreateInstance<KafkaConsumerStaticClientProvider>(
            serviceProvider,
            connectionName,
