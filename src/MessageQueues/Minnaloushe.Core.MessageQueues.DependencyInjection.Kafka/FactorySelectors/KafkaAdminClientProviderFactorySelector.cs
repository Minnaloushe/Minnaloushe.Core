...
public class KafkaAdminClientProviderFactorySelector
    : DefaultClientProviderFactorySelector<IKafkaAdminClientProvider, IKafkaAdminClientProviderFactory, MessageQueueOptions>,
