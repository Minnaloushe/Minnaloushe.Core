...
public interface IKafkaAdminClientProviderFactorySelector
    : IClientProviderFactorySelector<IKafkaAdminClientProvider, IKafkaAdminClientProviderFactory, MessageQueueOptions>;