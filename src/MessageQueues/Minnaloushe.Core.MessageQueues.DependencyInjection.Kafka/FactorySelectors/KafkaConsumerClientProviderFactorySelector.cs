...
public class KafkaConsumerClientProviderFactorySelector
    : DefaultClientProviderFactorySelector<IKafkaConsumerClientProvider, IKafkaConsumerClientProviderFactory, MessageQueueOptions>,
