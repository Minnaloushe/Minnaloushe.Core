...
public interface IKafkaProducerClientProviderFactorySelector
    : IClientProviderFactorySelector<IKafkaProducerClientProvider, IKafkaProducerClientProviderFactory, MessageQueueOptions>;