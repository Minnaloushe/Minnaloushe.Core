...
public static partial class VaultClientProviderBaseLogger
{
    [LoggerMessage(EventId = 3000, Level = LogLevel.Debug, Message = "ClientProvider constructed for connection '{ConnectionName}'")]
    public static partial void Constructed(this ILogger logger, string ConnectionName);

    [LoggerMessage(EventId = 3001, Level = LogLevel.Trace, Message = "Acquiring lease for connection '{ConnectionName}'")]
    public static partial void AcquiringLease(this ILogger logger, string ConnectionName);

    [LoggerMessage(EventId = 3002, Level = LogLevel.Debug, Message = "Issuing credentials for connection '{ConnectionName}'")]
    ...
    [LoggerMessage(EventId = 3006, Level = LogLevel.Information, Message = "Received credentials lease: LeaseId={LeaseId}, DurationSeconds={Duration}, Renewable={Renewable} for connection '{ConnectionName}'")]
    ...
    [LoggerMessage(EventId = 3007, Level = LogLevel.Information, Message = "Rotated provider for connection '{ConnectionName}' (Service={ServiceName}, Database={DatabaseName})")]
    ...
    [LoggerMessage(EventId = 3008, Level = LogLevel.Error, Message = "Failed to issue credentials for connection '{ConnectionName}': {Message}")]
    public static partial void IssueFailed(this ILogger logger, Exception exception, string ConnectionName, string Message);

    [LoggerMessage(EventId = 3009, Level = LogLevel.Debug, Message = "Renewing credentials lease '{LeaseId}' for connection '{ConnectionName}'")]
    ...
    [LoggerMessage(EventId = 3014, Level = LogLevel.Debug, Message = "Initializing ClientProvider credentials watcher for connection '{ConnectionName}'")]
    public static partial void InitializingWatcher(this ILogger logger, string ConnectionName);

    [LoggerMessage(EventId = 3015, Level = LogLevel.Information, Message = "ClientProvider credentials watcher started and attached to Vault parent for connection '{ConnectionName}'")]
